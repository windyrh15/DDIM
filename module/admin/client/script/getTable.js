let data;
const url = getClient;
const tbody = document.querySelector("#client_list tbody");
...
function displayData(
  ...
  paginatedData.forEach((data) => {
    ...
    row.innerHTML = `
            ...
            <td class="d-none d-md-table-cell ta-center" onclick="editClient('${data.client_id}'')"><i class="fa-solid fa-user-pen"></i></td>
        `;
