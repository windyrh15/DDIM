let data;
const url = getVendor;
const tbody = document.querySelector("#vendor_list tbody");
...
function displayData(
  ...
  paginatedData.forEach((data) => {
    ...
    row.innerHTML = `
            ...
            <td class="d-none d-md-table-cell ta-start">${data.vendor}</td>
            <td class="d-none d-md-table-cell ta-start">${data.pic}</td>
            <td class="d-none d-md-table-cell ta-end">${data.phone}</td>
            <td class="d-none d-md-table-cell ta-start">${data.city}</td>
            <td class="d-none d-md-table-cell ta-start">${data.address}</td>
            <td class="d-none d-md-table-cell ta-center" onclick="editVendor('${data.vendor_id}'')"><i class="fa-solid fa-user-pen"></i></td>
        `;
