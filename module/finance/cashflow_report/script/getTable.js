let data;
// const url = "";
const tbody = document.querySelector("#cashflow tbody");
...
function displayData(
  ...
  paginatedData.forEach((data) => {
    ...
    row.innerHTML = `
            ...
            <td class="d-none d-md-table-cell ta-end">${data.tanggal_transaksi}</td>
            <td class="d-none d-md-table-cell ta-end">${data.transaction_type}</td>
            <td class="d-none d-md-table-cell ta-end">${data.jenis_transaksi}</td>
            <td class="d-none d-md-table-cell ta-end">${data.akun}</td>
          <td class="d-none d-md-table-cell ta-end">${data.credit.toLocaleString()}</td>
          <td class="d-none d-md-table-cell ta-end">${data.debit.toLocaleString()}</td>
        `;
