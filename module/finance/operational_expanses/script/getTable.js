...
const urlMp = "api/finance/operationalExpanses.json";
// const urlFooterMp = dataTotalMp;
const tbodyMp = document.querySelector("#operational_expanses tbody");
const tfootMp = document.querySelector("#operational_expanses tfoot");
  ...
  data.forEach((marketingRecap) => {
    ...
    row.innerHTML = `
      ...
      marketingRecap.type
          ...
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.jan).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.feb).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.mar).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.apr).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.may).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.jun).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.jul).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.aug).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.sep).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.oct).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.nov).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.des).toLocaleString()}</td>
          <td class="ta-end d-none d-sm-table-cell">${parseFloat(marketingRecap.total).toLocaleString()}</td>
