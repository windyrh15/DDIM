...
const urlMp = "api/finance/cashFlowStatement.json";
// const urlFooterMp = dataTotalMp;
const tbodyMp = document.querySelector("#financial_report tbody");
const tfootMp = document.querySelector("#financial_report tfoot");
